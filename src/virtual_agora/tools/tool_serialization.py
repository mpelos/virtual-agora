...
def serialize_tool_calls_batch(tool_calls: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
...
def deserialize_tool_calls_batch(serialized: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
