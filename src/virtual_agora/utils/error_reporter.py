...
class ErrorReporter:
    ...
    def report_error(
        ...
        style, title = styles.get(context.severity, ("red", "❌ Error"))
    ...
    def _format_error_message(self, context: ErrorContext, show_details: bool) -> str:
    ...
    def detect_error_trends(self) -> List[str]:
        ...
        # Severity trends
        critical_count = sum(
            1 for c in self.reported_errors if c.severity == ErrorSeverity.CRITICAL
        )
        if critical_count >= 2:
