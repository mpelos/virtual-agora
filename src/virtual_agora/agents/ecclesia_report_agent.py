...
Your response must be valid JSON."""
        ...
        try:
            ...
            logger.warning(f"Using default report structure with {len(default_sections)} sections")
...
Focus on synthesis and analysis rather than repetition. Write professionally and concisely."""
        ...
        logger.info(f"Generated content for section '{section_title}' ({len(content)} chars)")
