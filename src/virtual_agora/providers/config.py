...
class ProviderConfig(BaseModel):
    ...
    model: str = Field(
        description="The model name/ID to use"
    )
...
class GoogleProviderConfig(ProviderConfig):
    ...
    provider: Literal[ProviderType.GOOGLE] = Field(
...
class OpenAIProviderConfig(ProviderConfig):
    ...
    provider: Literal[ProviderType.OPENAI] = Field(
...
class AnthropicProviderConfig(ProviderConfig):
    ...
    provider: Literal[ProviderType.ANTHROPIC] = Field(
...
class GrokProviderConfig(ProviderConfig):
    ...
    provider: Literal[ProviderType.GROK] = Field(
        default=ProviderType.GROK
    )
