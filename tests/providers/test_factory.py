...
class TestProviderFactory:
    ...
    def test_create_grok_provider(self, mock_init_chat_model):
        ...
        assert call_args[0] == "openai:grok-1"  # model identifier (uses openai for Grok)
    ...
    def test_unsupported_provider_raises_error(self):
        ...
        with patch('virtual_agora.providers.factory.registry.validate_model_config') as mock_validate:
    ...
    def test_import_error_handling(self, mock_init_chat_model):
        ...
        with patch.object(ProviderFactory, '_create_provider_instance_legacy') as mock_legacy:
