...
class TestProviderIntegration:
    ...
    def test_agent_conversation_with_anthropic(self, mock_anthropic_class):
        ...
        mock_response = Mock()
        mock_response.content = "I think AI ethics is crucial for responsible development."
    ...
    def test_all_providers_in_registry(self):
        ...
        for provider_type in providers:
            ...
            assert env_var is not None, f"Provider {provider_type} has no API key env var"
...
class TestProviderCompatibility:
    ...
    def test_streaming_support(self):
        ...
        for provider, model in streaming_models:
            ...
            assert model_info.supports_streaming, f"{provider}/{model} should support streaming"
    ...
    def test_function_calling_support(self):
        ...
        for provider, model in function_models:
            ...
            assert model_info.supports_functions, f"{provider}/{model} should support functions"
    ...
    def test_model_token_limits(self):
        ...
        for provider_type in registry.list_providers():
            ...
            for model_name in models:
                ...
                assert model_info.max_tokens >= 1000, f"{provider_type}/{model_name} has too low token limit"
                # And no more than 100K (reasonable upper bound)
                assert model_info.max_tokens <= 100000, f"{provider_type}/{model_name} has unreasonably high token limit"