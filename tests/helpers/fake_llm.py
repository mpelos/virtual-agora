...
class SummarizerFakeLLM(PredictableFakeLLM):
    ...
    def __init__(self, **kwargs):
        ...
        summarizer_patterns = {
            ...
            r"topic.*conclusion.*summary|create.*topic.*conclusion": "The discussion reached consensus on implementing a phased approach with systematic evaluation. Key agreements included prioritizing security measures and stakeholder engagement. Outstanding questions remain about resource allocation and timeline specificity. The practical implications involve establishing monitoring systems and regular review cycles.",
