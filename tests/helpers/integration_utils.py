...
from .fake_llm import FakeLLMBase, create_fake_llm_pool
...
class TestStateBuilder:
    ...
    def with_session_id(self, session_id: str) -> "TestStateBuilder":
        """Set session ID."""
        self.state["session_id"] = session_id
        return self

    def with_main_topic(self, topic: str) -> "TestStateBuilder":
        """Set main topic."""
        self.state["main_topic"] = topic
        return self

    def with_phase(self, phase: Union[str, int]) -> "TestStateBuilder":
        """Set current phase."""
    ...
    def with_agents(self, agents: Dict[str, AgentInfo]) -> "TestStateBuilder":
        """Set agents."""
        self.state["agents"] = agents
        return self

    def with_agenda(self, agenda: List[TopicInfo]) -> "TestStateBuilder":
        """Set agenda."""
        self.state["agenda"] = agenda
        return self

    def with_current_topic(self, topic_index: int) -> "TestStateBuilder":
        """Set current topic index."""
        self.state["current_topic_index"] = topic_index
        return self

    def with_round(self, round_num: int) -> "TestStateBuilder":
        """Set current round."""
        self.state["current_round"] = round_num
        return self

    def with_speaking_order(self, speaking_order: List[str]) -> "TestStateBuilder":
        """Set speaking order."""
        self.state["speaking_order"] = speaking_order
        return self

    def with_messages(self, messages: List[Message]) -> "TestStateBuilder":
        """Set messages."""
        self.state["messages"] = messages
        return self

    def with_hitl_state(self, hitl_state: HITLState) -> "TestStateBuilder":
        """Set HITL state."""
...
class IntegrationTestHelper:
    ...
    def create_test_config(self) -> VirtualAgoraConfig:
        ...
        return VirtualAgoraConfig(moderator=moderator, agents=agents)
        ...
        with patch(
            ...
            def mock_provider_creator(provider_config, use_cache=True):
                ...
                if "moderator" in model:
                    return self.fake_llms["moderator"]
                else:
...
def create_test_config_file(config_path, provider="openai", num_agents=3):
