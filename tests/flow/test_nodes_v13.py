...
class TestPhase2Nodes:
    ...
    def test_discussion_round_node(self, flow_nodes, mock_discussing_agents, mock_specialized_agents):
...
class TestPhase3Nodes:
    ...
    def test_final_considerations_node_vote_based(self, flow_nodes, mock_discussing_agents):
        """Test final considerations for minority voters."""
        state = {
            "active_topic": "Topic A",
            "user_forced_conclusion": False,
            "conclusion_vote": {
                "minority_voters": ["test_agent_2"]
            }
        }
