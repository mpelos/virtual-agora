...
class TestProposalCollector:
    ...
    def test_deduplicate_proposals(self):
        ...
        proposals = [
            ...
            Proposal(
                agent_id="agent_1", topic="Climate  Change"
    ...
    def test_normalize_topic(self):
        ...
        assert (
            self.collector._normalize_topic("  Technology Ethics  ")
            == "technology ethics"
        )
...
class TestAgendaManager:
    ...
    async def test_collect_modification_suggestions(self):
        ...
        self.moderator.request_agenda_modification.return_value = (
            "I suggest we add a new topic about technology"
        )
    ...
    def test_apply_agenda_modifications(self):
        ...
        items_by_topic = {
            item.topic: item for item in self.manager.state.current_agenda
        }
