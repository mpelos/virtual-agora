...
from virtual_agora.agenda.models import (
    Proposal, Vote, VoteType, AgendaItem, AgendaSynthesisResult,
    AgendaModification, ProposalStatus, VoteStatus
)
...
class TestAgendaSynthesizer:
    ...
    def test_prepare_synthesis_context(self):
        ...
        assert votes_summary[0]["preferences"] == ["Climate Change", "Technology Ethics"]
    ...
    def test_synthesize_agenda_success(self):
        ...
        self.moderator.synthesize_agenda.return_value = ["Climate Change", "Technology Ethics", "Economic Policy"]
        
        result = self.synthesizer.synthesize_agenda(proposals, votes)
        
        assert isinstance(result, AgendaSynthesisResult)
        assert result.proposed_agenda == ["Climate Change", "Technology Ethics", "Economic Policy"]
    ...
    def test_synthesize_agenda_with_retries(self):
        ...
        self.moderator.synthesize_agenda.side_effect = [
            ...
            ["Climate Change", "Technology Ethics", "Economic Policy"]  # Use actual topics from proposals
        ]
    ...
    def test_synthesize_modified_agenda(self):
        ...
        # Mock moderator response - synthesize_agenda returns a list directly  
        self.moderator.synthesize_agenda.return_value = ["New Topic", "Existing Topic 1"]
    ...
    def test_normalize_topic(self):
        ...
        assert self.synthesizer._normalize_topic("  Technology Ethics  ") == "technology ethics"
        assert self.synthesizer._normalize_topic("Economic  Policy") == "economic policy"
