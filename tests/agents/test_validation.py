...
from virtual_agora.agents.validation import (
    ValidationLevel, ResponseType, ValidationResult, ResponseValidator,
...
class TestResponseValidatorDiscussion:
    ...
    def test_validate_discussion_response_topic_relevant(self):
        ...
        assert not any("not be directly related" in warning for warning in result.warnings)
...
class TestResponseValidatorAgendaVote:
    ...
    def test_validate_agenda_vote_no_preferences(self):
        ...
        assert any("express clear preferences" in warning for warning in result.warnings)
...
class TestResponseValidatorConclusionVote:
    ...
    def test_validate_conclusion_vote_clear_yes(self):
        ...
        response = "Yes, I think we have adequately covered the main aspects of this topic."
    ...
    def test_validate_conclusion_vote_lacks_justification(self):
        ...
        assert any("should include justification" in warning for warning in result.warnings)
...
class TestResponseValidatorIntegration:
    ...
    def test_validate_response_error_handling(self):
        ...
        with patch.object(self.validator, '_validate_basic_format', side_effect=Exception("Test error")):
    ...
    def test_get_validation_statistics(self):
        ...
        self.validator.validate_response("Bad", ResponseType.TOPIC_PROPOSAL)  # Should fail
...
class TestValidationMiddleware:
    ...
    def test_validate_agent_response_success(self):
        ...
        mock_agent.generate_discussion_response.return_value = "Good discussion response"
...
class TestValidationIntegration:
    ...
    def test_full_validation_workflow(self):
        ...
        assert stats["successful_validations"] == sum(1 for _, _, valid in test_cases if valid)
    
    def test_validation_with_different_levels(self):
        """Test validation with different strictness levels."""
        response = "This is a moderately long response" + " that goes on" * 50  # Long response
        ...
        result_permissive = permissive_validator.validate_response(response, ResponseType.DISCUSSION)
        ...
        result_standard = standard_validator.validate_response(response, ResponseType.DISCUSSION)
        ...
        result_strict = strict_validator.validate_response(response, ResponseType.DISCUSSION)
    ...
    def test_response_cleaning_functionality(self):
        ...
        messy_response = "  This   has    extra spaces   \n\n\n\n and multiple newlines.  "
        ...
        assert result.cleaned_response.strip() == result.cleaned_response  # Should be trimmed