...
class TestBackoffCalculation:
    ...
    def test_exponential_backoff(self):
        ...
        assert calculate_backoff_delay(2, base_delay=1.0, exponential_base=3.0, jitter=False) == 9.0
    ...
    def test_max_delay_cap(self):
        ...
        delay = calculate_backoff_delay(100, base_delay=1.0, max_delay=30.0, jitter=False)
        assert delay == 30.0
