...
class TestStateManager:
    ...
    def test_agent_creation(self, state_manager):
        ...
        # Check participants
        participants = [a for a in state["agents"].values() if a["role"] == "participant"]
    ...
    def test_topic_management(self, state_manager, initialized_state):
        ...
        assert state_manager.state["topics_info"]["Future of Work"]["status"] == "active"
    ...
    def test_export_session(self, state_manager, initialized_state):
        ...
        state_manager.add_message(
            state_manager.state["current_speaker_id"],
            "Test message"
        )
