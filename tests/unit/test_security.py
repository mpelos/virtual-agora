...
class TestSecurityUtilities:
    ...
    def test_mask_api_key(self):
        ...
        assert mask_api_key("sk-1234567890abcdefghijklmnop") == "sk************************mnop"
    ...
    def test_validate_api_key_format(self):
        ...
        # Google keys
        valid, msg = validate_api_key_format("AIzaSyD-1234567890abcdefghijklmnopqrstuv", "Google")
    ...
    def test_check_env_file_security(self, tmp_path):
        ...
        try:
            ...
            os.chmod(env_file, stat.S_IRUSR | stat.S_IWUSR | stat.S_IRGRP | stat.S_IWOTH)
