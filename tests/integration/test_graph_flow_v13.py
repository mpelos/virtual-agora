...
class TestV13GraphFlow:
    ...
    def test_flow_initialization(self, v13_flow):
        ...
        assert (
            len(v13_flow.specialized_agents) == 4
        )  # moderator, summarizer, topic_report, ecclesia_report
    ...
    def test_phase_1_agenda_setting(self, v13_flow):
        ...
        for agent in v13_flow.discussing_agents:
            agent.return_value = {"messages": [Mock(content="Topic 1\nTopic 2")]}
    ...
    def test_dual_polling_system(self, v13_flow):
        ...
        # Test end topic poll
        state = {"active_topic": "Test Topic", "current_round": 3}
