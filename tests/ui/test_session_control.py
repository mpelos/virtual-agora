...
class TestSessionController:
    ...
    def test_interrupt_menu_resume(self, mock_prompt, session_controller):
        ...
        assert session_controller.console.print.called
        assert any("Resuming session" in str(call) 
    ...
    @patch('rich.prompt.Prompt.ask')
    def test_interrupt_menu_quit(self, mock_prompt, mock_confirm, mock_exit, session_controller):
