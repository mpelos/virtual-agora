...
class TestProposalTool:
    ...
    def test_proposal_tool_without_rationale(self):
        ...
        tool = ProposalTool()
        result = tool._run(topics=["Topic 1", "Topic 2", "Topic 3"])
    ...
    async def test_proposal_tool_async(self):
        ...
        tool = ProposalTool()
        result = await tool._arun(topics=["Async 1", "Async 2", "Async 3"])
...
class TestVotingTool:
    ...
    def test_voting_tool_yes_vote(self):
        ...
        tool = VotingTool()
        result = tool._run(
            topic="AI Ethics", vote="yes", reasoning="This is an important topic"
        )
    ...
    def test_voting_tool_no_vote(self):
        ...
        tool = VotingTool()
        result = tool._run(
            topic="Space Tourism", vote="no", reasoning="Not a priority right now"
        )
    ...
    def test_voting_tool_abstain(self):
        ...
        tool = VotingTool()
        result = tool._run(topic="Quantum Computing", vote="abstain")
    ...
    def test_voting_tool_invalid_vote(self):
        ...
        tool = VotingTool()
        result = tool._run(topic="Test Topic", vote="maybe")  # Invalid vote
...
class TestSummaryTool:
    ...
    def test_summary_tool_concise_style(self):
        ...
        result = tool._run(content=content, max_length=50, style="concise")
    ...
    def test_summary_tool_detailed_style(self):
        ...
        result = tool._run(content=content, max_length=150, style="detailed")
    ...
    def test_summary_tool_bullet_style(self):
        ...
        result = tool._run(content=content, style="bullet")
